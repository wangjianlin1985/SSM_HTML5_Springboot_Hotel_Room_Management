...
<div id="bookOrder_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit-new" plain="true" onclick="bookOrder_manage_tool.edit();">订单处理</a>
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="bookOrderQueryForm" method="post">
			...
			<br/>订单状态：<input type="text" class="textbox" id="orderState" name="orderState" style="width:110px" />
...
<div id="bookOrderEditDiv">
	<form id="bookOrderEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl"> 
				<select id="bookOrder_orderState_edit" name="bookOrder.orderState"  style="width:100px" >
